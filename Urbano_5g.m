...
lat_7 = latitudes_mobile(7);
lat_8 = latitudes_mobile(8);

% Create 10 equally spaced points between lat_7 and lat_8
new_lats = linspace(lat_7,lat_8,20);

% Insert the new points into the latitudes_mobile vector
latitudes_mobile = [latitudes_mobile(1:7), new_lats(2:end-1), latitudes_mobile(8:end)];
number_steps=number_steps+19;

%latitudes_mobile=[39.739006,39.738719,39.738315,[39.737893:0.001:39.733560],39.733470,39.733526,39.733707,39.7341]
...
% Get the latitudes of points 7 and 8
long_7 = longitudes_mobile(7);
long_8 = longitudes_mobile(8);

% Create 10 equally spaced points between lat_7 and lat_8
new_longs = linspace(long_7,long_8,20);

% Insert the new points into the latitudes_mobile vector
longitudes_mobile = [longitudes_mobile(1:7), new_longs(2:end-1), longitudes_mobile(8:end)];
...
scatter(-8.81205, handover_pot(14, 1), 'filled')
...
%% SINR PARA ARRAY ANTENAS 8X8 com Canais diferentes por Célula
% Array retangular de 8 por 8 antenas
% E SINR
%rx = rxsite('Name','Casa carlos', ...
%       'Latitude',39.74120, ...
